					...
					<div class="col-sm-6">
						<div class="col-sm-12">
							<div class="form-group">
								<label for="">{{ __('admin.users.email') }}</label>
					...
					<div class="col-sm-6">
						<div class="col-sm-12">
							<div class="form-group {{(($errors->has('current_password'))?'has-error':'')}}">
								<label for="">{{ __('admin.users.current_possword') }} <small>*</small></label>
						...
						<div class="col-sm-12">
							<div class="form-group {{(($errors->has('password'))?'has-error':'')}}">
								<label for="">{{ __('admin.users.new_possword') }} <small>*</small></label>
								<input class="form-control" type="password" name="password" placeholder="password" autocomplete="off" required/>
							</div>
						</div>
						<div class="col-sm-12">
							<div class="form-group {{(($errors->has('confirm_password'))?'has-error':'')}}">
								<label for="">{{ __('admin.users.confirm_possword') }} <small>*</small></label>
