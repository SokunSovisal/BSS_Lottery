...
var Base = function ($$$1) {
  var ClassName = {
    BMD_FORM_GROUP: "bmd-vs-form-group",
    IS_FILLED: "is-filled",
...
var BaseInput = function ($$$1) {
  ...
  var Default = {
    ...
    bmdFormGroup: {
      ...
      create: true,
      // create a wrapper if vs-form-group not found
    ...
    label: {
      ...
      //
      selectors: [".vs-form-control-label", // in the case of horizontal or inline forms, this will be marked
  ...
  var FormControlSizeMarkers = {
    "vs-form-control-lg": "bmd-vs-form-group-lg",
    "vs-form-control-sm": "bmd-vs-form-group-sm"
  };
  /**
   * ------------------------------------------------------------------------
   * Class Definition
  ...
  function (_Base) {
    ...
    function BaseInput($element, config, properties) {
      ...
      _this._rejectWithoutRequiredClasses(); // Resolve the vs-form-group first, it will be used for bmd-vs-form-group if possible
      //   note: different components have different rules


      _this.$formGroup = _this.findFormGroup(_this.config.formGroup.required); // Will add bmd-vs-form-group to vs-form-group or create an bmd-vs-form-group
      //  Performance Note: for those forms that are really performance driven, create the markup with the .bmd-vs-form-group to avoid
      //    rendering changes once added.

      _this.$bmdFormGroup = _this.resolveMdbFormGroup(); // Resolve and mark the bmdLabel if necessary as defined by the config

      _this.$bmdLabel = _this.resolveMdbLabel(); // Signal to the bmd-vs-form-group that a vs-form-control-* variation is being used
    ...
    }; // Will add bmd-vs-form-group to vs-form-group or create a bmd-vs-form-group if necessary
    ...
    _proto.resolveMdbFormGroup = function resolveMdbFormGroup() {
      ...
      if (mfg === undefined || mfg.length === 0) {
        if (this.config.bmdFormGroup.create && (this.$formGroup === undefined || this.$formGroup.length === 0)) {
          // If a vs-form-group doesn't exist (not recommended), take a guess and wrap the element (assuming no label).
          ...
          // a vs-form-group does exist, add our marker class to it
          this.$formGroup.addClass(ClassName.BMD_FORM_GROUP); // OLD: may want to implement this after all, see how the styling turns out, but using an existing vs-form-group is less manipulation of the dom and therefore preferable
          // A vs-form-group does exist, so add an bmd-vs-form-group wrapping it's internal contents
      ...
      return mfg;
    }; // Demarcation element (e.g. first child of a vs-form-group)
    //  Subclasses such as file inputs may have different structures


    _proto.outerElement = function outerElement() {
      return this.$element;
    }; // Will add bmd-label to bmd-vs-form-group if not already specified
    ...
    _proto.findMdbLabel = function findMdbLabel(raiseError) {
      ...
      if (label.length === 0 && raiseError) {
        $$$1.error("Failed to find " + Selector.BMD_LABEL_WILDCARD + " within vs-form-group for " + Util$2.describe(this.$element));
      }
    ...
    _proto.findFormGroup = function findFormGroup(raiseError) {
      ...
      return fg;
    }; // Due to the interconnected nature of labels/inputs/help-blocks, signal the bmd-vs-form-group-* size variation based on
    //  a found vs-form-control-* size


    _proto.resolveMdbFormGroupSizing = function resolveMdbFormGroupSizing() {
      if (!this.config.convertInputSizeVariations) {
        return;
      } // Modification - Change text-sm/lg to vs-form-group-sm/lg instead (preferred standard and simpler css/less variants)
...
var BaseSelection = function ($$$1) {
  ...
  var Default = {
    label: {
      ...
      //
      //selectors: [
      //  `.vs-form-control-label`, // in the case of horizontal or inline forms, this will be marked
...
var CheckboxInline = function ($$$1) {
  ...
  var Default = {
    bmdFormGroup: {
      create: false,
      // no bmd-vs-form-group creation if vs-form-group not present. It messes with the layout.
      required: false
    }
  };
  /**
...
var File = function ($$$1) {
  ...
  var Selector = {
    FILENAMES: "input.vs-form-control[readonly]"
  };
  /**
   * ------------------------------------------------------------------------
   * Class Definition
...
var BaseFormControl = function ($$$1) {
   ...
   */
  var Default = {
    requiredClasses: ["vs-form-control"]
  };
  /**
   * ------------------------------------------------------------------------
   * Class Definition
...
var Select = function ($$$1) {
  ...
  var JQUERY_NO_CONFLICT = $$$1.fn[JQUERY_NAME];
  var Default = {
    requiredClasses: ["vs-form-control||custom-select"]
  };
  /**
   * ------------------------------------------------------------------------
   * Class Definition
...
var Autofill = function ($$$1) {
  ...
  function (_Base) {
    ...
    _proto._attachEventHandlers = function _attachEventHandlers() {
      ...
      }).on("blur", ".vs-form-group input", function () {
